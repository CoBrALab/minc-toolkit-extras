...
volmash -swap zy ${tmpdir}/input.mnc ${tmpdir}/mash.mnc
volflip -z ${tmpdir}/mash.mnc ${tmpdir}/flip.mnc
...
antsRegistration_affine_SyN.sh --verbose --histogram-matching --fast --fixed-mask ${modelmask} \
