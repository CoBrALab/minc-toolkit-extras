...
print_help()
{
	...
	printf 'Usage: %s [-h|--help] [--moving-mask <arg>] [--fixed-mask <arg>] [--resampled-output <arg>] [--initial-transform <arg>] [--(no-)skip-affine] [--(no-)skip-nonlinear] [--(no-)clobber] <movingfile> <fixedfile> <outputbasename>\n' "$0"
